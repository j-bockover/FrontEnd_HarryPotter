...
import "../../src/components/sortinghat.js";
    ...
    <div className="Home">
      ...
      <form action="">
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="selfish" name="question4" value="selfish" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="stories" name="question5" value="stories" />
            <label for="stories">
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="violin" name="question10" value="violin" />
          ...
          <div>
            <input type="radio" id="blank10" name="question10" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            ...
            <label for="rune">
              The gleaming jet black box with a silver lock and key, marked with
              a mysterious rune that you know to be the mark of Merlin
            </label>
          </div>
          <div>
            <input type="radio" id="ornate" name="question12" value="ornate" />
            <label for="ornate">
          ...
          <div>
            <input type="radio" id="pewter" name="question12" value="pewter" />
            <label for="pewter">
          ...
          <div>
            <input type="radio" id="blank12" name="question12" value="blank" />
        ...
        <fieldset>
          <legend>
            ...
            It is about to smash, crush and tear several irreplaceable items and
            treasures. In which order would you rescue these objects from the
            troll's club, if you could?
          </legend>
          <div>
          ...
          <div>
            <input type="radio" id="blank13" name="question13" value="blank" />
            <label for="blank13">Blank</label>
          </div>
        </fieldset>
        <fieldset>
          <legend>
            Q14:Which of the following do you find most difficult to deal with?
          </legend>
          <div>
            <input type="radio" id="hunger" name="question14" value="hunger" />
          ...
          <div>
            <input type="radio" id="blank14" name="question14" value="blank" />
        ...
        <fieldset>
          <legend>
            Q20:One of your house mates has cheated in a Hogwarts exam by using
            a Self-Spelling Quill. Now he has come top of the class in Charms,
            beating you into second place. Professor Flitwick is suspicious of
            what happened. He draws you to one side after his lesson and asks
            you whether or not your classmate used a forbidden quill. What do
            you do?
          </legend>
          <div>
          ...
          <div>
            <input type="radio" id="points" name="question20" value="points" />
            <label for="points">
              Tell Professor Flitwick the truth. If your classmate is prepared
              to win by cheating, he deserves to be found out. Also, as you are
              both in the same house, any points he loses will be regained by
              you, for coming first in his place
            </label>
          </div>
          <div>
            <input
            ...
            <label for="forbidden">
              ...
              truth. If you knew that somebody was using a forbidden quill, you
              would tell the teacher before the exam started
            </label>
          </div>
          <div>
            <input type="radio" id="blank20" name="question20" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="doctor" name="question21" value="doctor" />
            <label for="doctor">
          ...
          <div>
            <input type="radio" id="blank21" name="question21" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="locked" name="question22" value="locked" />
            <label for="locked">
          ...
          <div>
            <input type="radio" id="waking" name="question22" value="waking" />
            <label for="waking">
          ...
          <div>
            <input type="radio" id="blank22" name="question22" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="street" name="question23" value="street" />
            <label for="street">
              The cobbled street lined with ancient buildings
            </label>
          </div>
          <div>
            <input type="radio" id="blank23" name="question23" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            ...
            />
            <label for="caution">
              Proceed with caution, keeping one hand on your concealed wand and
              an eye out for any disturbance?
            </label>
          </div>
          <div>
          ...
          <div>
            <input type="radio" id="ground" name="question24" value="ground" />
          ...
          <div>
            <input type="radio" id="blank24" name="question24" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="blank26" name="question26" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="blank27" name="question27" value="blank" />
        ...
        <fieldset>
          ...
          <div>
            <input type="radio" id="blank28" name="question28" value="blank" />
