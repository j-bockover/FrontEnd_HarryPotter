...
//submissions for question18
  ...
  if (gryffindor > ravenclaw && gryffindor > hufflepuff && gryffindor > slytherin) {
    ...
    document.getElementById("noanswer").hidden = true;
  } else if (hufflepuff > ravenclaw && hufflepuff > gryffindor && hufflepuff > slytherin) {
